...
void* result_request (void* sock_) {
    ...
    sprintf(file_name, "/home/oscreader/OS/project_copy/worker2/%d/myapp/result/result.txt", job_id);
    n = BUFSZ;
    ...
    if (pid == 0) {
        ...
        sprintf(dir_name, "/home/oscreader/OS/project_copy/worker2/%d", job_id);
...
void* exec_request(void* sock_){
    ...
    for (i = 0; i < source_num; i++) {
        ...
        sprintf(file_dir, "/home/oscreader/OS/project_copy/worker2/%d/", job_id);
    ...
    if (pid == 0) {
        ...
        sprintf(make_addr, "/home/oscreader/OS/project_copy/worker2/%d/myapp", job_id);
    ...
    if (pid == 0) {
        ...
        sprintf(exec_addr, "/home/oscreader/OS/project_copy/worker2/%d/myapp/bin/test", job_id);
        sprintf(store_addr, "/home/oscreader/OS/project_copy/worker2/%d/myapp/result/result.txt", job_id);
