...
void* file_transf(void* port) {
    ...
    char result_dir[128];
    sprintf(result_dir, "/home/oscreader/OS/project_copy/myapp/results/%d/result%d", job_id, result_index);
    result_index++;
...
int main(int argc, char* argv[]) {
    ...
    char dir_name[128]; 
    sprintf(dir_name, "/home/oscreader/OS/project_copy/myapp/results/%d", job_id);
